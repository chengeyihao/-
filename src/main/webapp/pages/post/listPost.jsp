...
<table width="100%" border="1" >
  ...
  <tr class="henglan" style="font-weight:bold;">
    ...
    <s:iterator var="post" value="#pageBean.data">
        <tr class="<s:property value="#sl.even ? 'tabtd2':'table1'"/>">
            ...
            <td width="7%" align="center">
                <a href="/post/findByPostId.action?postId=${post.postId}&department.depId=${post.department.depId}">
 ...
 <table border="0" cellspacing="0" cellpadding="0" align="center">
     <tr>
         <td align="right">
             ...
             <span>
        	<a href="/post/findAll.action?pageNum=0">[首页]</a>&nbsp;&nbsp;
            <a href="/post/findAll.action?pageNum=${pageBean.pageNum-1}">[上一页]</a>&nbsp;&nbsp;
                <s:iterator begin="#pageBean.start" end="#pageBean.end" var="num">
                    <s:if test="#num <= #pageBean.totalPage">
                            <a href="/post/findAll.action?pageNum=${num}">
            ...
            <a
                    <c:choose>
                        ...
                        <c:otherwise>href="/post/findAll.action?pageNum=${pageBean.pageNum + 1}"</c:otherwise>

                    </c:choose>
            >[下一页]</a>&nbsp;&nbsp;
            <a href="/post/findAll.action?pageNum=${pageBean.totalPage}">[尾页]</a>
        </span>
         </td>
     </tr>
 </table>

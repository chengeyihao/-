    ...
    <s:iterator var="dept" value="#pageBean.data">
        <tr class="<s:property value="#sl.even ? 'tabtd2':'table1'"/>">
            ...
            <td width="7%" align="center">
                <a href="/dept/findByDeptId.action?depId=${dept.depId}"><img
 ...
 <table border="0" cellspacing="0" cellpadding="0" align="center">
     <tr>
         <td align="right">
             ...
             <span>
        	<a href="/dept/find">[首页]</a>&nbsp;&nbsp;
            <a href="/dept/find?pageNum=${pageBean.pageNum-1}">[上一页]</a>&nbsp;&nbsp;
                <s:iterator begin="#pageBean.start" end="#pageBean.end" var="num">
                    <s:if test="#num <= #pageBean.totalPage">
                            <a href="/dept/find?pageNum=${num}">
            ...
            <a
                    <c:choose>
                        ...
                        <c:otherwise>href="/dept/find?pageNum=${pageBean.pageNum + 1}"</c:otherwise>

                    </c:choose>
            >[下一页]</a>&nbsp;&nbsp;
            <a href="/dept/find?pageNum=${pageBean.totalPage}">[尾页]</a>
        </span>
         </td>
     </tr>
 </table>
